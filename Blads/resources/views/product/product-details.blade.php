    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="sidebar">
            <h5>{{$prod->product_title}}</h5>
            </hr>
            <p style="color:green"> Currently {{$prod->product_availablity}}</p>
            <p> Brand : @if($prod->brand_name)
            {{$prod->brand_name}}
            @else
            No Brand
            @endif
            <P>
              ...
              <h3 style="color:#BE290B"> {{$prod->current_price}}</h3>
              <p> <del> $ {{$prod->regular_price}} </del></p>
              @else
              <h3 style="color:#BE290B"> {{$prod->regular_price}}</h3>
              @endif
            ...
            <h6 class="sidebar-title">About this item </h6>
