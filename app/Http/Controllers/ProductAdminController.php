...
class ProductAdminController extends Controller
{
    ...
    {
        $product_availablity = ProductAvaiability::all();
        return view('product-admin.create', compact('product_availablity'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $prod->product_availablity = $request->product_availablity;
    ...
    public function edit($id)
    {
        ...
        $product_availablity = ProductAvaiability::all();
        return view('product-admin.edit', compact('product', 'product_availablity'));
    }
    ...
    public function update(Request $request, Product $pro, $id)
    {
        ...
        $pro->update([
            ...
            $pro->product_availablity = $request->product_availablity,
