                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" id="postform" enctype="multipart/form-data" action="{{ route('product.store') }}" method="POST">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="current_price" name="current_price" style="width:66%" required autocomplete="current_price" autofocus>
                                    @error('current_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-2">Product Status </label>
                                <div class="col-sm-10">
                                    ...
                                    @foreach ($product_availablity as $cate)
